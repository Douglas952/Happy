          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <div className="button-select">
                <button
                  type="button"
                  className={open_on_weekends ? 'open-on-weekends' : ''}
                ...
                <button
                  type="button"
                  className={!open_on_weekends ? 'closed-on-weekends' : ''}
...
// return `https://a.tile.openstreetmap.org/${z}/${y}.png`;
